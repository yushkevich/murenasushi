...
export async function generateMetadata({ params }: RegulaminPageProps): Promise<Metadata> {
  ...
  return {
    title: `${content.footer.regulamin} | Murena`,
    description: content.seo.description,
    alternates: {
      canonical: `${baseUrl}/${locale}/regulamin`,
      languages: {
...
export default async function RegulaminPage({ params }: RegulaminPageProps) {
  ...
  const content = pageContent[locale].regulamin;
